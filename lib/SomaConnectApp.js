...
class SomaConnectApp extends Homey.App
{
    ...
    async add_editBridge(bridgeId, bridgeIP)
    {
        await this.mDNSBridgesUpdate( { id: bridgeId, address: bridgeIP });
    ...
    async mDNSBridgesUpdate( discoveryResult )
    {
        ...
        else if (ip)
        {
            ...
            this.Bridges.push( new SomaConnectBridge( this.homey, ip, id ) );
        }
